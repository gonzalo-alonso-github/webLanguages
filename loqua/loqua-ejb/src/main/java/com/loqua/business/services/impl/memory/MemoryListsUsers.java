...
public class MemoryListsUsers extends Observable{
	...
	public void setMostValuedUsersOfTheMonth(
		...
		MemoryListsUsers.mostValuedUsersOfTheMonth =
	...
	public void setMostActiveUsersOfTheMonth(
		...
		MemoryListsUsers.mostActiveUsersOfTheMonth =
	...
	public void setNumLastRegistrations(
		...
		MemoryListsUsers.numLastRegistrations = numLastRegistrations;
	}
	...
	public void setNumRegisteredUsers(int numUsers) {
		MemoryListsUsers.numRegisteredUsers = numUsers;
	}
